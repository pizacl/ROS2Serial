...
#include "ros2serial_msgs/msg/can.hpp"
#include "ros2serial_msgs/msg/can_array.hpp"
...
class CanNode : public rclcpp::Node {
    rclcpp::Publisher<ros2serial_msgs::msg::CANArray>::SharedPtr can_pub_;
    rclcpp::Subscription<ros2serial_msgs::msg::CANArray>::SharedPtr can_array_sub_;
   ...
   public:
    CanNode() : Node("ros2serial"), io(), port_(io), io_(io) {
        // パラメーター
        ...
        // ROS初期化
        can_pub_ = this->create_publisher<ros2serial_msgs::msg::CANArray>("can/rx", 10);
        can_array_sub_ = this->create_subscription<ros2serial_msgs::msg::CANArray>(
   ...
   private:
    void can_cb(const ros2serial_msgs::msg::CANArray::SharedPtr msg) {
    ...
    void handle_receive(const boost::system::error_code& error,
        ...
        if (boost::system::errc::success == error) {
            ...
            int i, len_read = 0;
            ros2serial_msgs::msg::CANArray can_array;
